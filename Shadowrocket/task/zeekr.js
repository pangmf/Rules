...
[Script]
zeekr = type=http-response, pattern=^https:\/\/api-gw-toc\.zeekrlife\.com\/zeekrlife-app-user\/v\d\/user\/info\/query$, script-path=https://raw.githubusercontent.com/pangmf/Rules/refs/heads/master/Shadowrocket/task/zeekr.js, requires-body=true, max-size=-1, timeout=60

极氪汽车签到 = type=cron, cronexp=1 0 * * *, script-path=https://raw.githubusercontent.com/pangmf/Rules/refs/heads/master/Shadowrocket/task/zeekr.js, timeout=120, wake-system=1
